...
import plugin.android.ss.com.breatheexercisehelper.R;

public class SetActivity extends Activity {

	private Button setButton;
	private String signalPositionStr,minHaleIntensityStr,maxHaleFrequencyStr,stantardPositionStr,stantardFrequencyStr,stantardIntensityStr,stantardRatioStr,displayTimeStr,sampleTimeStr,magnifyNStr;
	private EditText signalPositionEdit,maxHaleFrequencyEdit,minHaleIntensityEdit,stantardPositionEdit,stantardFrequencyEdit,stantardIntensityEdit,stantardRatioEdit,displayTimeEdit,sampleTimeEdit,magnifyNEdit;
	private double signalPosition,minHaleIntensity,maxHaleFrequency,stantardFrequency,stantardRatio,stantardPosition,stantardIntensity,displayTime,sampleOneOf,magnifyN;
	@Override
...
//		 loadSet();
		...
		displayTimeEdit=(EditText) findViewById(R.id.displayTimeData);
		...
		displayTimeEdit.setText(displayTime+"");
		...
		setButton.setOnClickListener(new ClickSetButton());//将监听器对象绑定在了MyButton对象上
	}
...
//				saveSet();
			...
			displayTimeStr=displayTimeEdit.getText().toString();
			...
			sendBundle.putDouble("displayTime", displayTime);
